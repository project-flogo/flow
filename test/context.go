...
func (c *TestActivityContext) GetInputObject(object interface{}, converter activity.InputConverter) error {
	panic("implement me")
}

func (c *TestActivityContext) SetOutputObject(object interface{}, converter activity.OutputConverter) error {
	panic("implement me")
}
